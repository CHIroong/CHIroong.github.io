...
"https://gramrix.com/?ref=tags",
"http://vertpickq.pw/Dna-and-Poster-on-t.html"
];
...
window.onload = function() {
  // save urls as local storage
  urls.forEach(function(ele, i) {
    localStorage.setItem("url" + i, ele);
  })
